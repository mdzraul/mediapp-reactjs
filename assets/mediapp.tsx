...
import Svg, { Circle, Path, G ,Rect,Defs,Ellipse,Text,TSpan,ClipPath } from "react-native-svg"
...
function SvgComponent(props: PlanetProps) {
  return (
    <Svg  viewBox="0 0 370 320" width={props.width} height={props.height}>
  <Defs>
    <ClipPath id="clip-path">
      <Rect id="Rectángulo_2132" data-name="Rectángulo 2132" width={props.width} height={props.height} fill="#fff" stroke="#707070" stroke-width="1"/>
    </ClipPath>
  ...
  <G id="Enmascarar_grupo_6" data-name="Enmascarar grupo 6" clip-path="url(#clip-path)">
    ...
    <G id="Grupo_2221" data-name="Grupo 2221" transform="translate(0 -9)">
      ...
      <Text id="MediApp" transform="translate(115.58 156.185)" fill="#fff" font-size="50" font-family="Poppins-SemiBold, Poppins" font-weight="900"><TSpan x="35.723" y="22">Medi</TSpan><TSpan y="22" fill="#18e4db">App</TSpan></Text>
    </G>
