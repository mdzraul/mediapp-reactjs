...
// /// COMPONENTS
 import Autenticados from "./src/navigation/RouteAutenticateStack"
 import NOAutenticados from "./src/navigation/RouteNoAuthenticateStack"
    ...
    <>
      <PaperProvider theme={theme}>
        ...
        <View style={styles.container}>
          ...
          {user ? <Text> Estas logueado</Text> :   <NOAutenticados/> }
